...
Como la variable this cambia de valor dentro del $watch, debemos
referenciarnos a ella guardandola en otra variable.

Si queremos poner un observador, debemos utilizar $scope, que debe 
quedar definido en el propio controller:
